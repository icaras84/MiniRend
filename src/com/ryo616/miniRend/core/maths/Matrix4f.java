...
public class Matrix4f {
    ...
    public float det(){
        float a = MathsEx.quick3fArrDet(new float[] {m[5], m[6], m[7], m[9], m[10], m[11], m[13], m[14], m[15]}) * m[0];
        float b = MathsEx.quick3fArrDet(new float[] {m[4], m[6], m[7], m[8], m[10], m[11], m[12], m[14], m[15]}) * m[1];
        float c = MathsEx.quick3fArrDet(new float[] {m[4], m[5], m[7], m[8], m[9],  m[11], m[12], m[13], m[15]}) * m[2];
        float d = MathsEx.quick3fArrDet(new float[] {m[4], m[5], m[6], m[8], m[9],  m[10], m[12], m[13], m[14]}) * m[3];
    ...
    public float getMinorDet(int element_idx){
        ...
        return MathsEx.quick3fArrDet(out3f);
    }
